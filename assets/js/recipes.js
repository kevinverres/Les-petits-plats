export { recipes };
import { getData1 } from "./program1.js";
import { getData2 } from "./program2.js";
const recipes = [
    {
        "id": 1,
...
function init() {
    ...
    if (program == 0) {
        ...
        body.innerHTML = "<img class='jsErr' src='/assets/img/JS_error.png' alt='Image javascript error'><p class = 'no_result3'>Aucun algorithme javascript trouvé...</p>";
    }
};
